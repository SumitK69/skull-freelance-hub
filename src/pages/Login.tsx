  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome back to Skull."
      });
        ...
        <Card className="skull-card border-border">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link to="/forgot-password" className="text-xs text-skull-purple hover:text-skull-pink">
                    Forgot password?
                  </Link>
                </div>
                <Input 
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="border-skull-light/20">
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link to="/register" className="text-skull-purple hover:text-skull-pink">
                Sign up
              </Link>
            </p>
          </CardFooter>
